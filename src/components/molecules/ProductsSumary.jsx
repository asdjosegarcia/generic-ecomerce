...
const ProductsSumary = (props) => {
    ...
    if(Object.keys(contexto.getProductsPrices).length &&  Object.keys(contexto.getProductsShippment).length){
        allProductsPrice=Object.values(contexto.getProductsPrices)
        allProductsPrice=(allProductsPrice.reduce((a,b)=>{ return a+b})).toFixed(2) //esto no es recomendable en un sistema con dinero real por obvias razones
